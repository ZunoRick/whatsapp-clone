        ...
        <div class="col-span-1">
            ...
            <div class="bg-white h-14 flex items-center px-4">
                <x-input
                    ...
                    placeholder='Buscar Chat o inicia uno nuevo'
                />
            </div>

            <div class="h-[80vh] overflow-auto border-t border-gray-200">
                ...
                @else
                    @foreach ($this->chats as $chatItem)
                        ...
                        >
                            ...
                            <div class="w-[85%] py-4 border-b border-gray-200">
        ...
        <div class="col-span-2">
            @if ($contactChat || $chat)
                <div class="bg-gray-100 h-16 flex items-center px-3">
                    ...
                    <div class="ml-4">
                        ...
                        @endif
                        <p class="text-green-500 text-xs">En línea</p>
                    </div>
                </div>
                
                <div class="h-[80vh] px-3 py-2 overflow-auto">
                ...
                <form 
                    class="bg-gray-200 h-16 flex items-center px-4"
                    wire:submit.prevent='sendMessage()'
                >
                    <x-input
                        wire:model.live="bodyMessage"
                        type='text'
                        class="flex-1"
            ...
            @else
                <div class="w-full h-full flex justify-center items-center">
                    <div>
                        <div class="_3SOOk" style="opacity: 1;"><span data-icon="intro-md-beta-logo-dark" class="_3PwsU">
    ...
    @push('js')
        <script>
            ...
            Livewire.on('scrollIntoView', function(){
                ...
                const span = document.querySelector("#final")
